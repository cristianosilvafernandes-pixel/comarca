 ...
 * Foro configurável via perfil (P-02). Advogado vem do profile (P-01).
...
export function montarContrato(i: ContratoInput): string {
  ...
  const advogadoOab = i.advogadoOab?.trim() || "[OAB]";
...
Pelo presente instrumento, ${clienteNome}, CPF ${clienteCpf}, residente em ${clienteEndereco}, doravante denominado CONTRATANTE, e o advogado ${i.advogadoNome}, ${advogadoOab}, doravante denominado CONTRATADO, têm entre si justo e contratado o seguinte:

1. OBJETO: Prestação de serviços advocatícios referentes a ${objeto}.
2. HONORÁRIOS: O CONTRATANTE pagará ao CONTRATADO o valor de ${valor}, nas condições acordadas.
